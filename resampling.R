...
excel_sheets("C:/Users/hmarq/Desktop/Planilhas para bootstrap.xlsx")

dieta_chvoso <- read_excel("C:/Users/hmarq/Desktop/Planilhas para bootstrap.xlsx", sheet = "Per?odo_Chuvoso")

dieta_seca <- read_excel("C:/Users/hmarq/Desktop/Planilhas para bootstrap.xlsx", sheet = "Per?odo_Seco")
